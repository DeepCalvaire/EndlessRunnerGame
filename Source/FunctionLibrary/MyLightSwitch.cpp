...
AMyLightSwitch::AMyLightSwitch()
{
	...
	// The blueprint asset needs to be recreated if the binding changes
...
void AMyLightSwitch::OnOverlapBegin(UPrimitiveComponent* OverlappedCom, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	UTheFunctionLibrary::ToggleAllLights();
	UTheFunctionLibrary::Print("kerqmoneoqi");
}
